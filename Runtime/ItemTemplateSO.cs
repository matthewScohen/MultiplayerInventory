...
public abstract class ItemTemplateSO : ScriptableObject
{
    ...
    [Rpc(SendTo.Server)] public abstract void ServerUse(NetworkObject playerOwner, int itemInstanceID, int actionID);
    ...
    /// <param name="itemInstanceID"></param>
    /// <param name="actionID">The id of the action to execute </param>
    [Rpc(SendTo.Everyone)] public abstract void ClientUse(NetworkObject playerOwner, int itemInstanceID, int actionID);
